// Все предыдущий задания на циклы - написать с помощью циклов for in 
// и/или for of

// Ну, я предыдущие циклы в этом уроке переделала. 
// Надеюсь, этого хватит. xD
...
function calculateValueRelations(randomArray) {
    for (var element of randomArray) {
        if (element > 0) {
            positiveValues += 1;
        }
        if (element < 0) {
